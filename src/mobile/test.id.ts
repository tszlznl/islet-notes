...
export const Calendar = {
  ...
  recordLivePhotoBadge: 'calendar.record-live-photo-badge',
...
export const DiaryChat = {
  ...
  editTimeDialog: 'diary-chat.edit-time-dialog',
  editTimeSave: 'diary-chat.edit-time-save',
  editTimeCancel: 'diary-chat.edit-time-cancel',
  editTimeYearWheel: 'diary-chat.edit-time-year-wheel',
  editTimeMonthWheel: 'diary-chat.edit-time-month-wheel',
  editTimeDayWheel: 'diary-chat.edit-time-day-wheel',
  editTimeHourWheel: 'diary-chat.edit-time-hour-wheel',
  editTimeMinuteWheel: 'diary-chat.edit-time-minute-wheel',
  ...
  livePhotoBadge: 'diary-chat.live-photo-badge',
